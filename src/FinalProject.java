		...
		while(run){
			...
			if(score<5 || score==5){
				if(Math.abs(hunterXarray[0]-playerX)<2*radius && 
						Math.abs(hunterYarray[0]-playerY)<2*radius){
			...
			if(score==6||score==7||score==8){
				...
				if(Math.abs(hunterXarray[1]-playerX)<2*radius && 
						Math.abs(hunterYarray[1]-playerY)<2*radius){
			...
			if(score>8){
				...
				if(Math.abs(hunterXarray[2]-playerX)<2*radius && 
						Math.abs(hunterYarray[2]-playerY)<2*radius){
					hunterXarray[2]= Math.random();
					hunterYarray[2]= Math.random();   
					score--;
				}
			}
